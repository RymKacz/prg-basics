...
print("Distances traveled (sorted):", sorted(distances_traveled))
# Sort the data in descending order, from highest to lowest value
daily_temperatures = [16, 17, 15, 14, 18, 19, 17, 15, 16, 18]
print("Daily temperatures (sorted descending):", sorted(daily_temperatures, reverse=True))
...
print("File names (sorted):", sorted(file_names))